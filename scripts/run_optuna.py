...
class PickIKOptuna(AbstractIK):
    ...
    def set_config(self, planning_group):
        ...
        reach_ros.set_parameter(f'robot_description_kinematics.{planning_group}.memetic_num_threads', 1)
        reach_ros.set_parameter(f'robot_description_kinematics.{planning_group}.memetic_stop_on_first_solution', True)
        reach_ros.set_parameter(f'robot_description_kinematics.{planning_group}.memetic_population_size', self.population_size)
        reach_ros.set_parameter(f'robot_description_kinematics.{planning_group}.memetic_elite_size', self.elite_size)
        reach_ros.set_parameter(f'robot_description_kinematics.{planning_group}.memetic_wipeout_fitness_tol',
                                self.wipeout_fitness_tol)
        reach_ros.set_parameter(f'robot_description_kinematics.{planning_group}.memetic_max_generations', self.max_generations)
        reach_ros.set_parameter(f'robot_description_kinematics.{planning_group}.memetic_gd_max_iters', self.gd_max_iters)
        reach_ros.set_parameter(f'robot_description_kinematics.{planning_group}.memetic_gd_max_time', self.gd_max_time)
        reach_ros.set_parameter(f'robot_description_kinematics.{planning_group}.gd_step_size', self.gd_step_size)
        reach_ros.set_parameter(f'robot_description_kinematics.{planning_group}.gd_min_cost_delta', 1.0e-12)
